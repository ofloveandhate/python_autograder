...
def feedback_to_pdf(feedback, outname):
    ...
    pypandoc.convert_file(temp_filename, 'pdf', outputfile=outname, extra_args=['-V','geometry:margin=1.5cm', '--include-in-header', '_autograding/autogenerated_header.tex'])
...
def autogenerate_header():
    with open ('_autograding/autogenerated_header.tex','w',encoding='utf-8') as f:
        pass#f.write('\\usepackage{nunito}\n\\usepackage[T1]{fontenc}\n')
